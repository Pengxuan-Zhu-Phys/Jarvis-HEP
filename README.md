...
**Where we are (2026-07-15):** D0–D7 runtime, D11 UI, and **D12.0–D12.6 + D12.8** are in
(including `Jarvis2 project …`, Examples GitHub catalog, restricted pack encrypt/decrypt via
CLI only). **Agent bridge (D8) is parked.** Open polish: D9/D10 partials. Authoritative ledger:
...
- Portal IO: `Jarvis-Books/Jarvis-HEP V2/DESIGN_PORTAL_IO_2.0.md`
