...
class OutputsFile(IOfile):
    ...
    def set_oup_slha(self, vinf, model="mssm"):
        if len(vinf) < 5:
            ...
            from old_record.slha import get_variable_info
    ...
    def get_slha(self):
        ...
        from old_record.slha import read_variable_value_by_xSLHA
    ...
    def get_xml(self):
        ...
        from old_record.xmlreader import read_variable_value
