# MALA Sampler Task List (Jarvis-HEP)
...
Add independent `MALA` sampler class with placeholder gradient-free drift on shared runtime.

## Task Checklist

- [x] Add `MALAChain` engine.
- [x] Add `MALA` sampler class.
- [x] Add Distributor method route (`Sampling.Method: "MALA"`).
- [x] Add sampler schema entry (`MALA_schema.json` + preference mapping).
