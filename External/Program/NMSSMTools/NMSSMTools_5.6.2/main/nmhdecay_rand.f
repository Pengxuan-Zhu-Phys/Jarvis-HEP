...
************************************************************************
      ...
      INTEGER GMUFLAG,HFLAG,NMSFLAG,UNCERTFLAG,GRFLAG,CFLAG(5)
      INTEGER NTOT,IDUM,NM1,NM2,NM3,NTB,NL,NK,NAL,NAK,NMU
      INTEGER NXIF,NXIS,NMUP,NMSP,NM3H,NMA,NMP
     ...
     . MSFLAG,AKFLAG,ALFLAG
      COMMON/STEPS/NTOT,IDUM,NM1,NM2,NM3,NTB,NL,NK,
     . NAL,NAK,NMU,NXIF,NXIS,NMUP,NMSP,NM3H,NMA,NMP
...
*******************************************************************
      ...
      INTEGER NXIF,NXIS,NMUP,NMSP,NM3H,NMA,NMP,CFLAG(5)
     ...
     . MUPMIN,MUPMAX,MSPMIN,MSPMAX,M3HMIN,M3HMAX,MAMIN,MAMAX,
     . MPMIN,MPMAX,M1MIN,M1MAX,M2MIN,M2MAX,M3MIN,M3MAX
      COMMON/STEPS/NTOT,ISEED,NM1,NM2,NM3,NTB,NL,NK,
     . NAL,NAK,NMU,NXIF,NXIS,NMUP,NMSP,NM3H,NMA,NMP
      COMMON/SCANFLAGS/M1FLAG,M2FLAG,M3FLAG,MHDFLAG,MHUFLAG,
     . MSFLAG,AKFLAG,ALFLAG
      COMMON/FLAGS/OMGFLAG,MAFLAG,MOFLAG
