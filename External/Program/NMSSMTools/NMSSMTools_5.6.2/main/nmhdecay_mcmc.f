...
************************************************************************
      ...
      INTEGER HFLAG,UNCERTFLAG,GRFLAG,CFLAG(5)
 ...
 14   IF(ITOT.EQ.1)THEN
      ...
      ELSE
       ...
       IF(TBDEV.EQ.0d0)THEN
        PAR(3)=TBCEN
       ELSE
 101    PAR(3)=TBCEN+MAX(DABS(TBCEN),TBMIN)*TBDEV*GAU(IDUM)
       ...
       IF(LDEV.EQ.0d0)THEN
        PAR(1)=LCEN
       ELSE
 102    PAR(1)=LCEN+MAX(DABS(LCEN),LMIN)*LDEV*GAU(IDUM)
        IF(PAR(1).LE.0d0)GOTO 102
       ENDIF
