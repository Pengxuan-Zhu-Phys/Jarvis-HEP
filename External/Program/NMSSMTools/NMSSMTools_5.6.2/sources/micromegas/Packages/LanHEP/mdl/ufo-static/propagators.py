...
ConstS = Propagator(name="ConstS",
                      numerator="complex(0,1)",
                      denominator="-Maux*Maux")

ConstF = Propagator(name="ConstF",
                      numerator="complex(0,1)*Identity(s1, s2)",
                      denominator="-Maux")

ConstV = Propagator(name="ConstV",
                      numerator="complex(0,-1)* Metric(l1, l2)",
                      denominator="-Maux*Maux")

ConstT = Propagator(name = "ConstT",
                numerator = "complex(0,1)*Metric(1, 51) * Metric(2, 52)",
                denominator =  "1"
               )
