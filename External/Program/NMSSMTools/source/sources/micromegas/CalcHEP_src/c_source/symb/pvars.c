...
{  int  i, p1, p2;
   ...
   for (i = 0; i < vardef->nvar; i++)   /*  numeration  */
	 ...
	 vardef->vars[i].num = scalarProductPos(p1,p2);
      ...
      else if(!strcmp(vardef->vars[i].name,"N_pol_11_")) vardef->vars[i].num=nmodelvar+5;
      else if(!strcmp(vardef->vars[i].name,"N_pol_12_")) vardef->vars[i].num=nmodelvar+6;
      else if(!strcmp(vardef->vars[i].name,"N_pol_21_")) vardef->vars[i].num=nmodelvar+7;
      else if(!strcmp(vardef->vars[i].name,"N_pol_22_")) vardef->vars[i].num=nmodelvar+8;
