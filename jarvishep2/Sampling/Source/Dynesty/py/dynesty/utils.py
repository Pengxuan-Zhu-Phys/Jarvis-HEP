...
# JARVIS: uidstar defaults to '' so unpatched DynamicNestedSampler call sites
# remain compatible until every yield path is updated.
...
IteratorResultShort = namedtuple(
    ...
    [
        ...
        'bounditer', 'eff', 'proposal_stats', 'uidstar',
    ],
)
