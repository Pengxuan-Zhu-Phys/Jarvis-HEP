...
#   Generated: Tue Nov 28 22:51:28 2023
...
#  First the compiler
if [ "$COMPILER" != "native" ] && [ -e /cvmfs/sft.cern.ch/lcg/releases/gcc/11.3.0/x86_64-centos7/setup.sh ]; then
    source /cvmfs/sft.cern.ch/lcg/releases/gcc/11.3.0/x86_64-centos7/setup.sh
fi

#  LCG version
LCG_VERSION=104b_ATLAS_3a; export LCG_VERSION
